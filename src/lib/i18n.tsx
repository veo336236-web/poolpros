...
const translations = {
  ...
  // Bookings
  "booking.title": { ar: "الحجوزات", en: "Bookings" },
  "booking.myBookings": { ar: "حجوزاتي", en: "My Bookings" },
  "booking.bookService": { ar: "حجز الخدمة", en: "Book Service" },
  "booking.preferredDate": { ar: "التاريخ المفضل", en: "Preferred Date" },
  "booking.notes": { ar: "ملاحظات إضافية", en: "Additional Notes" },
  "booking.notesPlaceholder": { ar: "أي تفاصيل إضافية عن طلبك...", en: "Any additional details about your request..." },
  "booking.submit": { ar: "إرسال طلب الحجز", en: "Submit Booking Request" },
  "booking.submitting": { ar: "جار الإرسال...", en: "Submitting..." },
  "booking.success": { ar: "تم إرسال طلب الحجز بنجاح! سيتم إعلامك عند الموافقة.", en: "Booking request sent! You'll be notified when approved." },
  "booking.loginRequired": { ar: "يجب تسجيل الدخول لحجز خدمة", en: "Please login to book a service" },
  "booking.pending": { ar: "قيد الانتظار", en: "Pending" },
  "booking.confirmed": { ar: "مقبول", en: "Approved" },
  "booking.rejected": { ar: "مرفوض", en: "Rejected" },
  "booking.completed": { ar: "مكتمل", en: "Completed" },
  "booking.cancelled": { ar: "ملغي", en: "Cancelled" },
  "booking.approve": { ar: "قبول", en: "Approve" },
  "booking.reject": { ar: "رفض", en: "Reject" },
  "booking.rejectReason": { ar: "سبب الرفض", en: "Rejection Reason" },
  "booking.rejectReasonPlaceholder": { ar: "اختياري: اذكر سبب الرفض...", en: "Optional: reason for rejection..." },
  "booking.noBookings": { ar: "لا توجد حجوزات بعد", en: "No bookings yet" },
  "booking.customer": { ar: "العميل", en: "Customer" },
  "booking.service": { ar: "الخدمة", en: "Service" },
  "booking.date": { ar: "التاريخ", en: "Date" },
  "booking.status": { ar: "الحالة", en: "Status" },
  "booking.requestedOn": { ar: "تاريخ الطلب", en: "Requested on" },
  "booking.provider": { ar: "مزود الخدمة", en: "Provider" },
  "booking.bookingRequests": { ar: "طلبات الحجز", en: "Booking Requests" },
  "booking.markComplete": { ar: "تم الإنجاز", en: "Mark Complete" },
